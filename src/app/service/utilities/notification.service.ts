...
export class NotificationService {
  ...
  cartImageNotificationRef: MdbNotificationRef<AddCartToastComponent> | null = null;
  ...
  openAddProductToCartToast(message: string): void {
    this.cartNotificationRef = this.mdbNotificationService.open(AddCartToastComponent, {
      data: {
        message,
  ...
  openAddProductToCartImageToast(productImage: string, produceArea: string, productName: string, productBrand: string): void {
    this.cartImageNotificationRef = this.mdbNotificationService.open(AddCartToastComponent, {
      data: {
        productImage,
        produceArea,
        productName,
