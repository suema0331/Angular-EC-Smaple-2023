...
export class LoginComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.form.valueChanges
      ...
      .subscribe((value) =>
        this.storageService.set('login_form', JSON.stringify(value))
      );
    ...
    this.activatedRoute.queryParams
      .pipe(filter((param) => param['return']))
      .subscribe((params) => {
  ...
  validateMailError(): boolean {
    const userAccountValidation =
      this.validationService.validateMailErrorOnLogin(String(this.form_email));
  ...
  validatePasswordError(): boolean {
    const userAccountValidation =
      this.validationService.validatePasswordErrorOnLogin(
